...
<head>
    ...
    <title>Déposer de l'argent sur un compte</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
<%
String notifDepot=(String)session.getAttribute("notifDepot");
if (notifDepot==null)notifDepot=""; %>
            <div class="container-fluid">
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Déposer de l'argent sur un compte<br>
                            <small><%=notifDepot %></small>
                        </h1>
                        <p/>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="DepotArgentServlet" method="post">
                           <div class="form-group">
                                <input class="form-control" placeholder="RIB du compte bénificiaire" name="rib" type="number" required="required">
...
<%session.setAttribute("notifDepot", null); %>
