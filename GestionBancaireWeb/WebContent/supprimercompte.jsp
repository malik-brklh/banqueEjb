...
<head>
    ...
    <title>Fermer un compte bancaire</title>
...
<%String notifSupp = (String)session.getAttribute("notifSupp");
if(notifSupp==null)notifSupp="";
%>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
              <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Fermer un compte bancaire<br>
                          <small>  <%=notifSupp %></small>
                            
                        </h1>
                        <p/>        
                        <h3>Saisissez le RIB du compte à fermer :
                        </h3>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="SuppCompteServlet" method="post">
                           <div class="form-group">
                                <input class="form-control" placeholder="RIB du compte à fermer" name="rib" type="number" required="required">
                                <button type="submit" class="btn btn-default">Fermer le compte</button>
                            </div>
                        </form>
                    </div>
                </div>
<%
session.setAttribute("notifSupp", null);%>
