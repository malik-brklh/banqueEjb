...
<head>
    ...
    <title>Retirer de l'argent d'un compte</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
<%
String notifRetrai=(String)session.getAttribute("notifRetrai");
if (notifRetrai==null)notifRetrai=""; %>
            <div class="container-fluid">
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Retirer de l'argent d'un compte<br>
                            <small><%=notifRetrai %></small>
                        </h1>
                        <p/>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="RetraitArgentServlet" method="post">
                           <div class="form-group">
                                <input class="form-control" placeholder="RIB du compte à débiter" name="rib" type="number" required="required">
                                <input class="form-control" placeholder="Montant à retirer" name="montant" type="number" required="required">
...
<%session.setAttribute("notifRetrai", null); %>
