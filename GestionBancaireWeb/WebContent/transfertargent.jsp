...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
<%
String notifTransf=(String)session.getAttribute("notifTransf");
if (notifTransf==null)notifTransf=""; %>
            <div class="container-fluid">
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Transférer de l'argent entre deux comptes de la banque<br>
                            <small><%=notifTransf %></small>
                        </h1>
                        <p/>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="TransfArgentServlet" method="post">
                           <div class="form-group">
                               <input class="form-control" placeholder="RIB du compte à débiter (de)" name="rib1" type="number" required="required">
                               <input class="form-control" placeholder="RIB du compte à créditer (vers)" name="rib2" type="number" required="required">
                                <input class="form-control" placeholder="Montant à déposer" name="montant" type="number" required="required">
...
<%session.setAttribute("notifTransf", null); %>
