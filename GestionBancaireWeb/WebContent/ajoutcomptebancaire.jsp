...
<head>
    ...
    <title>Ajouter un compte bancaire à un client</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Ajouter un compte bancaire à un client
                            <br><small>Le client doit être existant</small>
                        </h1>
                        <p/>
<%
String comptecreer=(String)session.getAttribute("comptecreer");
if (comptecreer==null){ %>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="AjoutCBServlet" method="post">
                           <div class="form-group">
                                <input class="form-control" placeholder="CIN du propriétaire du compte" name="cin" type="number" required="required">
                                <input class="form-control" placeholder="Montant du premier dépôt" name="montant" type="number" required="required">
...
<%session.setAttribute("comptecreer", null); %>
