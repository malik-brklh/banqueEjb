...
<head>
    ...
    <title>Modifier les données d'un client</title>
...
String clientmodife=(String)session.getAttribute("clientmodife");
if (clientmodife==null)clientmodife="";
if(client==null){ %>	
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Modifier les données d'un clientt<br>
                          <small>  <%=clientmodife %></small>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="ModifClientServlet" method="post">
...
<%}else{ %>  
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Modifier les données d'un client<br>
                            
                        </h1>
                        <p/>        
                        <h3>Saisissez le nouvelles données :</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="ModifClientServlet" method="post">
                           <div class="form-group">
                                <input class="form-control" name="prenom" placeholder="Prénom" value="<%=client.getPrenom()%>"  required="required">
                                <input class="form-control" name="nom" placeholder="Nom de famille" value="<%=client.getNom()%>"  required="required">
                                <input class="form-control" name="adresse" placeholder="Adresse" value="<%=client.getAdresse()%>"  required="required">
                                <input class="form-control" name="cin" type="number" value="<%=client.getCin()%>" disabled="disabled" required="required">
                                <button type="submit" class="btn btn-default">Chercher</button>
                            </div>
                        </form>
                    </div>
...
<%}
session.setAttribute("clientmodife", null);
%>
