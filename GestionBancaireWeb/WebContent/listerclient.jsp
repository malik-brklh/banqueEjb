...
<%ArrayList<ClientDTO> clientDTOs = (ArrayList<ClientDTO>)session.getAttribute("clients");
if (clientDTOs==null){
                    ...
                    <div class="col-lg-12">
                       <div class="table-responsive">
	                    	<table class="table table-hover table-striped">
	                    		<thead>
	                    		<tr>
	                    			<div  class="col-lg-6"><th>Informations du client</th></div>
	                    			<div  class="col-lg-6"><th>Comptes du client</th></div>
	                    		</tr>
	                    		</thead>
	                    		<tbody>
	          		<% for(ClientDTO clientDTO:clientDTOs){ %>
                       <tr>
	                    <td>
		                   <div class="row" >  <div class="col-lg-2"><b>CIN : </b></div><div class="col-lg-4"><a href="ChercherClientServlet?cin=<%=clientDTO.getCin() %>"><%=clientDTO.getCin() %></a></div></div>
		                   <div class="row" >  <div class="col-lg-2"><b>Nom : </b></div><div class="col-lg-4"><%=clientDTO.getNom() %></div></div>
		                   <div class="row" >  <div class="col-lg-2"><b>Prénom : </b></div><div class="col-lg-4"><%=clientDTO.getPrenom() %></div></div>
		                   <div class="row" >  <div class="col-lg-2"><b>Adresse : </b></div><div class="col-lg-4"><%=clientDTO.getAdresse() %></div></div></td>
                        <td>
	                    <div class="table-responsive">
	                    	<table class="table table-hover table-striped">
	                    		<thead>
	                    		<tr>
	                    			<div class="col-lg-3"><th>RIB</th></div>
	                    			<div class="col-lg-3"><th>Solde</th></div>
	                    		</tr>
	                    		</thead>
	                    		<tbody>
	                    		<% for(CompteBancaireDTO compteBancaireDTO : clientDTO.getCompteBancaireDTOs()){ %>
	                  		    	<tr>
