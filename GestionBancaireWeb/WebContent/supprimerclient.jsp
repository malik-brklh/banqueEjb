        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
              <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Supprimer un client<br>
                          <small>  <%=notifSupp %></small>
                            
                        </h1>
                        <p/>        
                        <h3>Saisissez le CIN du client :
                        <br><small>La supression entrainera la supression de tous les comptes du client</small>
                        </h3>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form role="form" action="SuppClientServlet" method="post">
